...
// Open the existing page in a new browser window or tab
...
for (let i = 0; i < category.length; i++) {
  category[i].addEventListener("click", () => {
    ...
    // Open the category page with the selected category as a URL parameter
    window.open(urlToOpen + "?category=" + encodedItem, "_blank");
  });
}
